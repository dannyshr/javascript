			...
			return this.filter(function(){
				...
				.each(function(){ 
					...
					$('img', this).each(function(n) {
						...
						var me = $(this);
						var s0 = me.attr('src'); //'small' image source
						var s1 = (op.source ? op.source.call(me[0], n) : false) || jqDock.altImage.call(this) || s0; //'large' image source?
						var tx = op.labels ? me.attr('title') || me.parent('a').attr('title') || '' : ''; //label text?
