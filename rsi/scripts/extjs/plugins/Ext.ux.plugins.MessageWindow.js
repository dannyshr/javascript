...
/**
 * @class Ext.ux.plugins.MessageWindowGroup
 * @extends Ext.WindowGroup
 * An object that represents a group of {@link Ext.ux.plugins.MessageWindow} instances
 * and provides position management in addition to the standard Window Group features.
 * @constructor
 */
Ext.ux.plugins.MessageWindowGroup = function (config) {
    config = config || {};
...
/**
 * @class Ext.ux.plugins.MessageWindowMgr
 * @extends Ext.ux.plugins.MessageWindowGroup
 ...
 * {@link Ext.ux.plugins.MessageWindowGroup} as needed.
 * @singleton
 */
Ext.ux.plugins.MessageWindowMgr = Ext.ux.plugins.MessageWindowGroup(); 

/**
 * @class Ext.ux.plugins.MessageWindow
 * @extends Ext.Window
 ...
 */
Ext.ux.plugins.MessageWindow = Ext.extend(Ext.Window, {
    ...
    */
    ...
    /**
     * @cfg {Ext.ux.plugins.MessageWindowGroup} manager
     * A reference to the MessageWindowGroup that should manage this Message Window (defaults 
     * to {@link Ext.ux.plugins.MessageWindowMgr}). Specify a reference to an instance unless
     * you want a new manager for each instance:
     * <pre><code>
     * var group2 = new Ext.ux.plugins.MessageWindowGroup({
     ...
     * });
     * var mw1 = new Ext.ux.plugins.MessageWindow({
     *     manager: group2//specify the MessageWindowGroup manager (instead of using default manager)
     * });
     * var mw2 = new Ext.ux.plugins.MessageWindow({
     *     manager: group2//specify the MessageWindowGroup manager (instead of using default manager)
     * });
     * var mw3 = new Ext.ux.plugins.MessageWindow({
...
//added this.closable
        ...
        //call parent
        Ext.ux.plugins.MessageWindow.superclass.initComponent.call(this);
        ...
        this.addEvents(
             ...
             * @param {Ext.ux.plugins.MessageWindow} this
             */
            /**
             * @event deactivate
             ...
             * @param {Ext.ux.plugins.MessageWindow} this
             * @param {Ext.ux.plugins.MessageWindow} msg The message from the message array if configured.
             */
            'click');
    ...
    initEvents: function () {
        ...
        //use a slighly enhanced Ext.ux.plugins.MessageWindowMgr instead of the default WindowMgr
        this.manager = this.manager || Ext.ux.plugins.MessageWindowMgr;

        //the parent class will register, so no need to do it here:
        //this.manager = this.manager || Ext.WindowMgr;
        
        Ext.ux.plugins.MessageWindow.superclass.initEvents.call(this);
    },

    focus: function () {
        Ext.ux.plugins.MessageWindow.superclass.focus.call(this);
    },
    ...
    initTools: function () {
        ...
        Ext.ux.plugins.MessageWindow.superclass.initTools.apply(this, arguments);
    },

    /** @private */
    onRender: function (ct, position) {
        Ext.ux.plugins.MessageWindow.superclass.onRender.call(this, ct, position);
...
<div class="{0}-bl">
 ...
 <div class="x-box-bwrap" id="ext-gen117">
    ...
    createElement : function (name, pnode) {
        if (this.shiftHeader) {
            ...
            case 'header':
                ...
                return;
            case 'tbar':
                Ext.ux.plugins.MessageWindow.superclass.createElement.call(this, 'header', pnode);
                Ext.ux.plugins.MessageWindow.superclass.createElement.call(this, name, pnode);
                return;
            }
        }
    ...
    /** @private */
    getState : function () {
        return Ext.apply(Ext.ux.plugins.MessageWindow.superclass.getState.call(this) || {}, this.getBox());
    },
    ...
    /** @private */
    afterShow: function () {
        Ext.ux.plugins.MessageWindow.superclass.afterShow.call(this);
    ...
    setTitle: function (title, iconCls) {
        Ext.ux.plugins.MessageWindow.superclass.setTitle.call(this, title, iconCls || this.iconCls);
    },
...
//register the xtype
Ext.reg('messageWindow', Ext.ux.plugins.MessageWindow);
