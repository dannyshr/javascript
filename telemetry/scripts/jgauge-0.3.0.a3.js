...
function jGauge(_size)
{
        ...
        jG.config = null;
        jG.size = (_size==null || _size=="undefine") ? gaugeSize.large : ((_size=="small") ? gaugeSize.small : gaugeSize.large);
        ...
        jG.imagePath = (jG.size==gaugeSize.small) ? 'images/jgauge_face_default.png' : 'images/jgauge_face_default_L.png'; // Background image path.
        jG.width = (jG.size==gaugeSize.small) ? 160 : 239; // Total width of jGauge.
        jG.height = (jG.size==gaugeSize.small) ? 114 : 170; // Total height of jGauge.
        ...
        {
                var ndl = this;
                ndl.imagePath = (jG.size==gaugeSize.small) ? 'images/jgauge_needle_default.png' : 'images/jgauge_needle_default_L.png'; // Needle image path.
        ...
        function label()
        {
                ...
                lbl.yOffset = (jG.size==gaugeSize.small) ? 20 : 55; // Shift label vertically from center.
        }
        ...
        function ticks()
        {
                ...
                tks.radius = (jG.size==gaugeSize.small) ? 76 : 102; // Tick mark radius (from gauge center point).
                tks.labelPrecision = 1; // Rounding decimals for tick labels.
                tks.labelRadius = (jG.size==gaugeSize.small) ? 63 : 90; // Tick label radius (from gauge center).
        ...
        function range()
        {
                ...
                rng.color = (jG.size==gaugeSize.small) ? 'rgba(255, 32, 0, 0.2)' : 'rgba(255, 32, 0, 0)'; // Color and alpha (opacity) of the range arc.
        }
	 ...
	 */
        function init()
        {
                ...
                //$('#' + jG.id).css('background-size', jG.width + 'px ' + jG.height + 'px');
                //$('#' + jG.id).css('background-repeat', 'no-repeat');
